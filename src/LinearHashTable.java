 ...
 * Tracks access statistics and handles collisions with linear probing.
 *
 * @author: Yash Parmar
 * @param <E> The type of elements stored in the hash table
 */

public class LinearHashTable<E> implements StatisticsSet<E> {
    ...
    /**
     * Constructs a new LinearHashTable with the specified initial capacity.
     *
    ...
    /**
     * Finds the index of the specified object in the table using linear probing.
     *
    ...
    protected int findIndex(E obj) {
        ...
        for (int i = 0; i < table.length; i++) {
            int currentIndex = Math.floorMod(hash + i, table.length);
    ...
    /**
     * Resets the count of table accesses.
     */
    ...
    /**
     * Returns the number of table accesses made.
     *
